...
export class SolutionRepository {
    ...
    storeMysql(solution) {
        ...
        return this.table().insert(solution).then().catch(e => {
            throw e
        });
    }
    ...
    getQueryForSolution(solution) {
        ...
        if (solution.code) {
            terms.code = solution.code;
        }
        if (solution.level) {
            terms.level = solution.level;
        }
        if (solution.message) {
            match.message = solution.message;
        }
        if (solution.os) {
            terms.os = solution.os
        }
        if (solution.os_version) {
            terms.os_version = solution.os_version
        }
        if (solution.programminglanguage) {
            terms.programminglanguage = solution.programminglanguage
        }
        if (solution.programminglanguage_version) {
            terms.programminglanguage_version = solution.programminglanguage_version
        }
