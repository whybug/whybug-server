...
export class WebRoutes {
    ...
    getPages() {
        return [
            {
                name: 'startpage',
                path: routes.web.startpage.path,
                handler: StartPage
            },
            {
                name: 'search',
                path: routes.web.solution.search.path,
                handler: SearchSolutionsPageController
            },
            {
                name: 'solution_create',
                path: routes.web.solution.create.path,
                handler: SolveErrorPageController
            },
            {
                name: 'solution_view',
                path: routes.web.solution.view.path,
                handler: ViewSolutionPageController
            },
            {
                name: 'language_index',
                path: routes.web.installation.index.path,
                handler: InstallationPage
            },
            {
                name: 'language',
                path: routes.web.installation.language.path,
                handler: InstallationPage
            }
        ];
    }
